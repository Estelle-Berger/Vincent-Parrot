    ...
    <div>
        <div class="p-2">
            <div class="d-flex flex-wrap justify-content-center gap-2">
                <div class= "align-self-center flex-wrap">
                    ...
                    <p class="col responsive-text d-flex justify-content-center flex-wrap border rounded-2 p-2" 
                    style="max-width: 50rem;">Vincent Parrot, fort de ses 15 années d'expérience dans la réparation automobile, 
                    a ouvert son propre garage à Toulouse en 2021.<br>
                Depuis 2 ans, il propose une large gamme de services : réparation de la carrosserie et de la mécanique des voitures 
                ainsi que leur entretien régulier pour garantir leur performance et leur sécurité. De plus, le Garage V.Parrot met 
                en vente des véhicules d'occasion.<br>Vincent Parrot considère son atelier comme un véritable lieu de confiance
                pour ses clients et leurs voitures doivent, selon lui, à tout prix être entre de bonnes mains.
                </p>
                </div>
                
                <div class="p-5 col-md-4 d-flex align-items-center justify-content-center survol">
                ...
                <div class="p-2 d-flex justify-content-evenly gap-2 flex-wrap ">
                    <div class="card survol" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Le garage propose des travaux de carrosserie et de réparation de l'intérieur
                                de la voiture ainsi que des jantes.</p>
                        </div>
                    </div>
                    <div class="card survol" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Une panne, une casse, un accident ? On s'occupe d'effectuer les diagnostics et 
                                réparations mécaniques de votre voiture.</p>
                        </div>
                    </div>
                    <div class="card survol" style="width: 18rem;" >
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Besoin d'effectuer une révision ? Notre service rapide vous accueille pour 
                                l'ensemble des interventions concernant l'entretien de votre véhicule.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="">
            ...
            <div class="d-flex justify-content-center flex-wrap">
                ...
                <div class="p-2 col d-flex justify-content-center">
                    <div class="card survol" style="width: 15rem;">
        ...
        <div class="fond ">
            ...
            <div class="p-2 d-flex justify-content-center">
                <div id="carouselExample" class="carousel slide fixed-carousel ">
                    <div class="carousel-inner justify-content-center">
                    <?php 
                    $first = true;
                    foreach($save_avis as $avis){
                    ...
                    ?>
                        <div class="carousel-item <?=$activeClass?>">
                            <div class="d-flex justify-content-center flex-wrap">
                                <div class="p-2 col">
                                    <div class="card fixed-card" style="width: 18em;">
