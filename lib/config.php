...
if($_SERVER["REQUEST_METHOD"] == "POST" AND isset($_POST['valid_login'])){
    ...
    // $password_save = htmlspecialchars($hashPassword, ENT_QUOTES,'UTF-8');
    if($email != ""){
...
if(isset($_POST['save_service'])){
    ...
    $category_save = htmlspecialchars($category, ENT_QUOTES,'UTF-8');

    if(isset($_FILES['file'])){
        $tmpName = $_FILES['file']['tmp_name'];
        $picture = './uploads/services/'.$title_save;
        $picture_save = htmlspecialchars($picture, ENT_QUOTES,'UTF-8');
...
if(isset($_POST['save_cars'])){
    ...
    unset($_SESSION["message_delete"]);
    $brand = $_POST['brand'];
    $brand_save = htmlspecialchars($brand, ENT_QUOTES,'UTF-8');
    $model = $_POST['model'];
    ...
    $fuel = $_POST['fuel'];
    $fuel_save = htmlspecialchars($fuel, ENT_QUOTES,'UTF-8');
